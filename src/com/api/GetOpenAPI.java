...
public class GetOpenAPI {
	public WifiInfoDTO getWifiInfo() {
		...
		try {
			...
			urlBuilder.append("/"
					+ URLEncoder.encode("6143456b656b686738377a79427468", "UTF-8")); /* 인증키 */
			urlBuilder.append("/" + URLEncoder.encode("json", "UTF-8")); /* 요청파일타입 (json) */
			urlBuilder.append("/" + URLEncoder.encode("TbPublicWifiInfo", "UTF-8")); /* 서비스명 (대소문자 구분 필수입니다.) */
			urlBuilder.append("/" + URLEncoder.encode("1", "UTF-8")); /* 요청시작위치  */
			urlBuilder.append("/" + URLEncoder.encode("900", "UTF-8")); /* 요청종료위치 */
